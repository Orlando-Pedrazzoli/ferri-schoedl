...
export default function LoginPage() {
  ...
  // Read URL params for messages (from email verification, etc.)
  useEffect(() => {
        ...
        <form onSubmit={handleSubmit} className='space-y-5'>
          ...
          <div>
            <div className='mb-1.5 flex items-center justify-between'>
              <label
                htmlFor='password'
                className='text-xs font-medium uppercase tracking-wider text-txt-muted'
              >
                Password
              </label>
              <span className='text-xs text-txt-muted/50'>
                {/* Placeholder para futuro "esqueci a password" */}
              </span>
            </div>
