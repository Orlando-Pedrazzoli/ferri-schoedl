    ...
    <section className="pb-24 pt-32 lg:pb-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <SectionHeading
          ...
          description="Com sede em Sao Paulo e atuacao em todo o Brasil, o escritorio e reconhecido por seu atendimento tecnico, responsavel e humanizado."
        />
        ...
        <Reveal className="mt-16 text-center">
          <p className="mb-6 text-[15px] text-txt-muted">
            Cada situacao exige analise tecnica individual.
          </p>
          <Link
            href="/contato"
