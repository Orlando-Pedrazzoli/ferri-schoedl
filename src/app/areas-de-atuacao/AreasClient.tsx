...
export function AreasClient({ areasData }: AreasClientProps) {
  // Build a map of slug -> icon from data.ts (icons are React components)
  const iconMap = Object.fromEntries(areasDeAtuacao.map(a => [a.slug, a.icon]));
