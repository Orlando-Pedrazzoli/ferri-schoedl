...
import { BookOpen, GraduationCap, Scale, FileText, Users, Award } from "lucide-react";
...
const cursos = [
  {
    icon: Scale,
    title: "Direito Penal",
    desc: "Parte geral e especial com enfoque pratico e jurisprudencial.",
  },
  {
    icon: FileText,
    title: "Processual Penal",
    desc: "Teoria e pratica processual com analise de casos reais.",
  },
  {
    icon: BookOpen,
  ...
  },
  {
    ...
    desc: "Foco em servidores publicos, regime disciplinar e improbidade.",
  },
  {
    icon: GraduationCap,
    title: "Preparatorio Concursos",
    desc: "Magistratura, Ministerio Publico, Procuradorias e Defensorias.",
  },
  {
    icon: Award,
    title: "Exame OAB",
    desc: "Preparatorio completo com questoes comentadas e simulados.",
  },
];
  ...
  return (
    <section className="pb-24 pt-32 lg:pb-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <SectionHeading
          label="Formacao juridica"
          title="Cursos e preparatorios"
          description="Coaching juridico e preparatorios com a experiencia de quem viveu a magistratura, o ensino e a advocacia estrategica."
        />
            ...
            <div className="grid gap-8 lg:grid-cols-3">
              <div>
                ...
                <p className="mt-3 text-[14px] text-txt-muted">
                  ...
                  Educacao e UNIESP. Coordenador de bancas de exame oral
                  simulado.
                </p>
              </div>
              <div>
                ...
                <p className="mt-3 text-[14px] text-txt-muted">
                  Autor de &quot;2243 Questoes para Concursos Publicos&quot; (938p.) e
                  coautor de &quot;Questoes Comentadas do Exame Oral&quot; — obras de
                  referencia na preparacao para concursos.
                </p>
              </div>
              <div>
                <p className="text-[11px] uppercase tracking-[2px] text-gold-500">
                ...
                <p className="mt-3 text-[14px] text-txt-muted">
                  Abordagem pratica que conecta teoria, jurisprudencia e
                  questoes de prova, resultado de mais de 20 anos de experiencia
                  na area juridica.
                </p>
              </div>
            </div>
        ...
        <Reveal className="mt-16">
          <div className="mx-auto max-w-xl text-center">
            ...
            <h3 className="font-[family-name:var(--font-cormorant)] text-2xl text-cream-100">
              Seja avisado do lancamento
            </h3>
            <p className="mt-3 text-[14px] text-txt-muted">
              Cadastre seu e-mail para receber informacoes sobre os cursos,
              datas e condicoes especiais de lancamento.
            </p>

            {submitted ? (
              <div className="mt-8 border border-gold-500/20 bg-gold-500/5 p-6">
                <p className="text-[14px] text-gold-400">
                  E-mail cadastrado com sucesso. Voce sera avisado sobre o
                  lancamento dos cursos.
                </p>
              </div>
            ) : (
              <form
